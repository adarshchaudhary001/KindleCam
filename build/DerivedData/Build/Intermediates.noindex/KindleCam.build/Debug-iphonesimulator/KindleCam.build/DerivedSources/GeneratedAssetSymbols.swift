...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let spoon = DeveloperToolsSupport.ImageResource(name: "spoon", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "spoon" asset catalog image.
    static var spoon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .spoon)
#else
        .init()
...
extension UIKit.UIImage {
    ...
    /// The "spoon" asset catalog image.
    static var spoon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .spoon)
#else
        .init()
